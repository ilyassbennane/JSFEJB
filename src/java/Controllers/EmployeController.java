...
public class EmployeController implements Serializable {
    ...
    private List<Machine> machinesAssignedToSelectedEmploye;
...
public List<Machine> getMachinesAssignedToSelectedEmploye() {
    if (selected != null && selected.getId() != null) {
        return getFacade().find(selected.getId()).getMachineList();
    }
    return new ArrayList<>();
}

public void setMachinesAssignedToSelectedEmploye(List<Machine> machinesAssignedToSelectedEmploye) {
    this.machinesAssignedToSelectedEmploye = machinesAssignedToSelectedEmploye;
}
public void viewMachinesForSelectedEmploye() {
    // Update the list of machines assigned to the selected employee
    machinesAssignedToSelectedEmploye = getMachinesAssignedToSelectedEmploye();
}
